...
#let live-item-data = (
  "Decimal": (
    ...
    [
      ...
      = #babel(en: [Construction and casts]) <construction-and-casts>
      #babel(
        en: [
      ...
      = #babel(en: [Operations]) <operations>
      #babel(
        en: [
      ...
      = #babel(en: [Displaying decimals]) <displaying-decimals>
      #babel(
        en: [
      ...
      = #babel(en: [Precision and limits]) <precision-and-limits>
      #babel(
        en: [
