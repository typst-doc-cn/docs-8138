...
#let live-item-data = (
  "RootedPath": (
    ...
    [
      ...
      = #babel(en: [Path strings]) <path-strings>
      #babel(
        en: [
      ...
      = #babel(en: short-or-long[Path Type][The path type]) <path-type>
      #babel(
        en: [
      ...
      = #babel(en: [Roots]) <roots>
      == #babel(en: short-or-long[Project Root][The project root]) <project-root>
      #babel(
        en: [
      ...
      == #babel(en: [Package roots]) <package-roots>
      #babel(
        en: [
      ...
      = #babel(en: [Further operations]) <further-operations>
      #babel(
        en: [
