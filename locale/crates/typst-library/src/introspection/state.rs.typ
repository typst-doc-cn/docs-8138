...
#let live-item-data = (
  "State": (
    ...
    [
      ...
      = #babel(en: short-or-long[State And Markup][State and document markup]) <state-and-markup>
      #babel(
        en: [
      ...
      = #babel(en: short-or-long[State In Typst][Managing state in Typst]) <state-in-typst>
      #babel(
        en: [
