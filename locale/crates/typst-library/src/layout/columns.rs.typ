...
#let live-item-data = (
  "ColumnsElem": (
    ...
    [
      ...
      = #babel(en: short-or-long[Page Level][Page-level columns]) <page-level>
      #babel(
        en: [
      ...
      = #babel(en: short-or-long[Breaking Out][Breaking out of columns]) <breaking-out>
      #babel(
        en: [
