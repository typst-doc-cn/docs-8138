...
#import "/components/index.typ": docs-chapter, docs-figure, docs-table, short-or-long, side-by-side
...
The @pdf.standard[PDF reference page] contains more information about each supported standard. To enable either PDF/UA, PDF/A-2a, or PDF/A-3a, use the @pdf:command-line[appropriate flag in the CLI] or use the export dropdown and click on PDF in the web app. You can combine compatible PDF/A and PDF/UA standards. For accessibility-focused documents, we recommend combining PDF/UA-1 with PDF/A-2a or PDF/A-3a.
