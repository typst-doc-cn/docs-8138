...
= #short-or-long[Customize Margins][Customize page size and margins] <customize-margins>
...
== #short-or-long[Alternating Margins][Different margins on alternating pages] <alternating-margins>
...
= #short-or-long[Headers And Footers][Add headers and footers] <headers-and-footers>
...
== #short-or-long[Specific Pages][Different header and footer on specific pages] <specific-pages>
...
== #short-or-long[Specific Elements][Adapt headers and footers on pages with specific elements] <specific-elements>
...
= #short-or-long[Page Numbers][Add and customize page numbers] <page-numbers>
...
== #short-or-long[Skip Pages][Reset the page number and skip pages] <skip-pages>
...
= #short-or-long[Columns][Add columns] <columns>
...
== #short-or-long[Columns Anywhere][Use columns anywhere in your document] <columns-anywhere>
